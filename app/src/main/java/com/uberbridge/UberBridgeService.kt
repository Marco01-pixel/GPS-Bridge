...
class UberBridgeService : Service() {
    private val TAG = "UberBridgeService"
    ...
    override fun onCreate() {
        super.onCreate()
        gson = Gson()
        Log.d(TAG, "UberBridgeService creado")
    ...
    private fun createNotification(): Notification {
        ...
        val channelName = "Uber Bridge Service"
    ...
    private fun getBluetoothData(): String {
        ...
        try {
            ...
            // Receiver para capturar dispositivos durante el escaneo
            val scanReceiver = object : BroadcastReceiver() {
                override fun onReceive(context: Context, intent: Intent) {
                    ...
                    if (BluetoothDevice.ACTION_FOUND == action) {
                        ...
                        if (device != null && !discoveredDevices.contains(device.address)) {
            ...
            // Esperar 4 segundos para el escaneo
            Thread.sleep(4000)
            ...
            // Si no se encontraron dispositivos, devolver los emparejados
            ...
            return gson.toJson(mapOf(
                "type" to "BLUETOOTH",
                "devices" to foundDevices,
                "count" to foundDevices.size,
                "enabled" to true,
                "scanning" to true
            ))
        } catch (e: Exception) {
            Log.e(TAG, "Error en Bluetooth: ${e.message}")
            return """{"error":"${e.message}"}"""
        }
    }
